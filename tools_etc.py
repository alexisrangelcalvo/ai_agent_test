...
def create_average_metric_tool(df_tools: pd.DataFrame):
    ...
    el promedio de la métrica para una lista de países y una columna específica.
    ...
    return FunctionTool.from_defaults(
        ...
        description="Dada una lista de países y una columna numérica, calcula el promedio de dicha métrica para esos países."
    )